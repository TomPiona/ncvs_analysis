...
use "2013/individual/35164-0003-Data.dta", clear

// running supplied do file that changes the missing data values to stata format instead of -99, etc.
do "2013/individual/35164-0003-Supplemental_syntax.do"
do "/Users/ronaldwalker/econ154/ncvs_analysis/indiv.do"

* MERGING (this is the greatest thing to happen since sliced bread)

// merging incident data
merge 1:m IDPER YEARQ using 2013/incident/35164-0004-Data.dta
drop if _merge != 3
drop _merge

// merging household data
merge m:1 IDHH YEARQ using 2013/household/35164-0002-Data.dta
drop if _merge != 3
drop _merge
